...
// //   const userName = location.state?.name || "User";  // ✅ Get name from location
// //   const profileID = location.state?.profileID || null;  // ✅ Get profileID from location
...
// //       <h1>Welcome to {userName}'s Profile!</h1>  {/* ✅ Correct Name Displayed */}
// //       <p>Coming soon: User Profile feature!</p>
// //       <button onClick={handleSubmit}>Submit</button>  {/* Navigate back */}
// //     </div>
// //   );
// // };
